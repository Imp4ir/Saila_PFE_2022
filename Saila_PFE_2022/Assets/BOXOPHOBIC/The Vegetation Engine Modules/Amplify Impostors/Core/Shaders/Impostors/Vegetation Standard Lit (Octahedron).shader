...
Shader "BOXOPHOBIC/The Vegetation Engine/Impostors/Vegetation Standard Lit (Octahedron)"
{
    ...
    SubShader
    {
        ...
        Pass
        {
           ...
           #include "Assets/BOXOPHOBIC/The Vegetation Engine/Core/Includes/VS_Indirect.cginc"
           ...
           #pragma multi_compile GPU_FRUSTUM_ON __
            ...
            GraphVertexOutput vert (GraphVertexInput v)
        	{
				...
				float3 temp_output_3563_0_g53655 = worldPosOut99;
				float3 worldToObj3565_g53655 = mul( GetWorldToObjectMatrix(), float4( temp_output_3563_0_g53655, 1 ) ).xyz;
				float3 VertexPosition3564_g53655 = worldToObj3565_g53655;
				half3 VertexPos40_g53671 = VertexPosition3564_g53655;
				float3 appendResult74_g53671 = (float3(VertexPos40_g53671.x , 0.0 , 0.0));
				half3 VertexPosRotationAxis50_g53671 = appendResult74_g53671;
				float3 break84_g53671 = VertexPos40_g53671;
				float3 appendResult81_g53671 = (float3(0.0 , break84_g53671.y , break84_g53671.z));
				half3 VertexPosOtherAxis82_g53671 = appendResult81_g53671;
				float Motion_Max_Bending1133_g53655 = 3.14;
				...
				half3 ObjectData20_g53683 = appendResult20_g53682;
				float3 ase_worldPos = mul(GetObjectToWorldMatrix(), v.vertex).xyz;
				half3 WorldData19_g53683 = ase_worldPos;
				#ifdef TVE_VERTEX_DATA_BATCHED
				float3 staticSwitch14_g53683 = WorldData19_g53683;
				#else
				float3 staticSwitch14_g53683 = ObjectData20_g53683;
				#endif
				float3 temp_output_114_0_g53682 = staticSwitch14_g53683;
				float3 ObjectPosition4422_g53655 = temp_output_114_0_g53682;
				float2 panner73_g53679 = ( _TimeParameters.x * (TVE_NoiseParams).xy + ( (ObjectPosition4422_g53655).xz * TVE_NoiseParams.z ));
				float4 tex2DNode75_g53679 = tex2Dlod( TVE_NoiseTex, float4( panner73_g53679, 0, 0.0) );
				float4 saferPower77_g53679 = max( abs( tex2DNode75_g53679 ) , 0.0001 );
				float3 Position83_g53692 = ObjectPosition4422_g53655;
				float temp_output_84_0_g53692 = _LayerMotionValue;
				float4 lerpResult87_g53692 = lerp( TVE_MotionParams , SAMPLE_TEXTURE2D_ARRAY_LOD( TVE_MotionTex, samplerTVE_MotionTex, ( (TVE_MotionCoord).zw + ( (TVE_MotionCoord).xy * (Position83_g53692).xz ) ),temp_output_84_0_g53692, 0.0 ) , TVE_MotionUsage[(int)temp_output_84_0_g53692]);
				half4 Global_Motion_Params4344_g53655 = lerpResult87_g53692;
				float4 break322_g53685 = Global_Motion_Params4344_g53655;
				half Wind_Power369_g53685 = break322_g53685.z;
				half Wind_Power2223_g53655 = Wind_Power369_g53685;
				float temp_output_167_0_g53679 = Wind_Power2223_g53655;
				float lerpResult168_g53679 = lerp( 1.4 , 0.2 , temp_output_167_0_g53679);
				float4 temp_cast_3 = (lerpResult168_g53679).xxxx;
				float4 break174_g53679 = pow( saferPower77_g53679 , temp_cast_3 );
				half Global_NoiseTex_R34_g53655 = break174_g53679.r;
				float lerpResult376_g53685 = lerp( TVE_MotionParamsMin.x , TVE_MotionParamsMax.x , Wind_Power369_g53685);
				half Wind_Power_103106_g53655 = lerpResult376_g53685;
				float temp_output_3572_0_g53655 = saturate( VertexPosition3564_g53655.y );
				half Mesh_Motion_1082_g53655 = temp_output_3572_0_g53655;
				float3 appendResult397_g53685 = (float3(break322_g53685.x , 0.0 , break322_g53685.y));
				float3 temp_output_398_0_g53685 = (appendResult397_g53685*2.0 + -1.0);
				float3 ase_parentObjectScale = ( 1.0 / float3( length( GetWorldToObjectMatrix()[ 0 ].xyz ), length( GetWorldToObjectMatrix()[ 1 ].xyz ), length( GetWorldToObjectMatrix()[ 2 ].xyz ) ) );
				float3 temp_output_339_0_g53685 = ( mul( GetWorldToObjectMatrix(), float4( temp_output_398_0_g53685 , 0.0 ) ).xyz * ase_parentObjectScale );
				half2 Wind_DirectionOS39_g53655 = (temp_output_339_0_g53685).xz;
				half Input_Speed62_g53656 = _MotionSpeed_10;
				float mulTime373_g53656 = _TimeParameters.x * Input_Speed62_g53656;
				half Motion_Variation284_g53656 = 0.0;
				float Motion_Scale287_g53656 = ( _MotionScale_10 * ( ase_worldPos.x + ase_worldPos.y + ase_worldPos.z ) );
				half Sine_MinusOneToOne281_g53656 = sin( ( mulTime373_g53656 + Motion_Variation284_g53656 + Motion_Scale287_g53656 ) );
				half Wind_Squash4440_g53655 = break322_g53685.w;
				half Input_WindSquash419_g53656 = Wind_Squash4440_g53655;
				half Input_WindPower327_g53656 = Wind_Power_103106_g53655;
				float lerpResult321_g53656 = lerp( Sine_MinusOneToOne281_g53656 , (Sine_MinusOneToOne281_g53656*Input_WindSquash419_g53656 + 1.0) , Input_WindPower327_g53656);
				half2 Motion_Bending2258_g53655 = ( ( _MotionAmplitude_10 * Motion_Max_Bending1133_g53655 ) * Global_NoiseTex_R34_g53655 * Wind_Power_103106_g53655 * Mesh_Motion_1082_g53655 * Wind_DirectionOS39_g53655 * lerpResult321_g53656 );
				half Interaction_Amplitude4351_g53655 = _InteractionAmplitude;
				float3 Position83_g53691 = ObjectPosition4422_g53655;
				float temp_output_84_0_g53691 = _LayerReactValue;
				float4 lerpResult87_g53691 = lerp( TVE_ReactParams , SAMPLE_TEXTURE2D_ARRAY_LOD( TVE_ReactTex, samplerTVE_ReactTex, ( (TVE_ReactCoord).zw + ( (TVE_ReactCoord).xy * (Position83_g53691).xz ) ),temp_output_84_0_g53691, 0.0 ) , TVE_ReactUsage[(int)temp_output_84_0_g53691]);
				half4 Global_React_Params4413_g53655 = lerpResult87_g53691;
				float4 break322_g53673 = Global_React_Params4413_g53655;
				half Interaction_Mask66_g53655 = break322_g53673.z;
				float3 appendResult397_g53673 = (float3(break322_g53673.x , 0.0 , break322_g53673.y));
				float3 temp_output_398_0_g53673 = (appendResult397_g53673*2.0 + -1.0);
				float3 temp_output_339_0_g53673 = ( mul( GetWorldToObjectMatrix(), float4( temp_output_398_0_g53673 , 0.0 ) ).xyz * ase_parentObjectScale );
				half2 Interaction_DirectionOS4349_g53655 = (temp_output_339_0_g53673).xz;
				float lerpResult4444_g53655 = lerp( 1.0 , Mesh_Motion_1082_g53655 , _InteractionMaskValue);
				half2 Motion_Interaction53_g53655 = ( Interaction_Amplitude4351_g53655 * Motion_Max_Bending1133_g53655 * Interaction_Mask66_g53655 * Interaction_Mask66_g53655 * Interaction_DirectionOS4349_g53655 * lerpResult4444_g53655 );
				float2 lerpResult109_g53655 = lerp( Motion_Bending2258_g53655 , Motion_Interaction53_g53655 , ( Interaction_Mask66_g53655 * saturate( Interaction_Amplitude4351_g53655 ) ));
				float2 break143_g53655 = lerpResult109_g53655;
				half Motion_Z190_g53655 = break143_g53655.y;
				half Angle44_g53671 = Motion_Z190_g53655;
				half3 VertexPos40_g53670 = ( VertexPosRotationAxis50_g53671 + ( VertexPosOtherAxis82_g53671 * cos( Angle44_g53671 ) ) + ( cross( float3(1,0,0) , VertexPosOtherAxis82_g53671 ) * sin( Angle44_g53671 ) ) );
				float3 appendResult74_g53670 = (float3(0.0 , 0.0 , VertexPos40_g53670.z));
				half3 VertexPosRotationAxis50_g53670 = appendResult74_g53670;
				float3 break84_g53670 = VertexPos40_g53670;
				float3 appendResult81_g53670 = (float3(break84_g53670.x , break84_g53670.y , 0.0));
				half3 VertexPosOtherAxis82_g53670 = appendResult81_g53670;
				half Motion_X216_g53655 = break143_g53655.x;
				half Angle44_g53670 = -Motion_X216_g53655;
				float3 Vertex_Motion_Object833_g53655 = ( VertexPosRotationAxis50_g53670 + ( VertexPosOtherAxis82_g53670 * cos( Angle44_g53670 ) ) + ( cross( float3(0,0,1) , VertexPosOtherAxis82_g53670 ) * sin( Angle44_g53670 ) ) );
				half Global_VertexTex_Size174_g53655 = break322_g53673.w;
				float lerpResult346_g53655 = lerp( 1.0 , Global_VertexTex_Size174_g53655 , _GlobalSize);
				float3 appendResult3480_g53655 = (float3(lerpResult346_g53655 , lerpResult346_g53655 , lerpResult346_g53655));
				half3 Vertex_Size1741_g53655 = appendResult3480_g53655;
				half3 _Vector5 = half3(1,1,1);
				float3 Vertex_SizeFade1740_g53655 = _Vector5;
				half IsInitialized3811_g53655 = _IsInitialized;
				float3 Final_VertexPosition890_g53655 = ( ( ( ( Vertex_Motion_Object833_g53655 * Vertex_Size1741_g53655 * Vertex_SizeFade1740_g53655 ) - VertexPosition3564_g53655 ) * IsInitialized3811_g53655 ) + _DisableSRPBatcher );
				...
				o.ase_texcoord8.w = 0;
				v.vertex.xyz += Final_VertexPosition890_g53655;
        	...
        	half4 frag (GraphVertexOutput IN, out float outDepth : SV_Depth ) : SV_Target
            {
				...
				half3 Main_Albedo_Raw4295_g53655 = o.Albedo;
				float dotResult4302_g53655 = dot( float3(0.2126,0.7152,0.0722) , Main_Albedo_Raw4295_g53655 );
				float3 temp_cast_0 = (dotResult4302_g53655).xxx;
				float4 break3589_g53655 = output0;
				half Main_Mask_Leaves3712_g53655 = ceil( break3589_g53655.g );
				float lerpResult4305_g53655 = lerp( _ImpostorBarkSaturationValue , _ImpostorLeafSaturationValue , Main_Mask_Leaves3712_g53655);
				float3 lerpResult4303_g53655 = lerp( temp_cast_0 , Main_Albedo_Raw4295_g53655 , lerpResult4305_g53655);
				float4 lerpResult4310_g53655 = lerp( _ImpostorBarkColor , _ImpostorLeafColor , Main_Mask_Leaves3712_g53655);
				float dotResult4323_g53655 = dot( float3(0.2126,0.7152,0.0722) , Main_Albedo_Raw4295_g53655 );
				float3 temp_cast_2 = (dotResult4323_g53655).xxx;
				float3 lerpResult4317_g53655 = lerp( temp_cast_2 , Main_Albedo_Raw4295_g53655 , _ImpostorGrassSaturationValue);
				#ifdef TVE_IS_GRASS_SHADER
				float3 staticSwitch4322_g53655 = ( lerpResult4317_g53655 * (_ImpostorGrassColor).rgb );
				#else
				float3 staticSwitch4322_g53655 = ( lerpResult4303_g53655 * (lerpResult4310_g53655).rgb );
				#endif
				half3 Main_Albedo3817_g53655 = staticSwitch4322_g53655;
				half3 Blend_Albedo4137_g53655 = Main_Albedo3817_g53655;
				float3 temp_cast_3 = (_NoiseScaleValue).xxx;
				float3 temp_output_3563_0_g53655 = worldPos;
				float3 World_Pos4027_g53655 = temp_output_3563_0_g53655;
				float temp_output_7_0_g53696 = _NoiseMinValue;
				half Noise_Mask4030_g53655 = saturate( ( ( tex3D( TVE_WorldTex3D, ( temp_cast_3 * World_Pos4027_g53655 * 0.1 ) ).r - temp_output_7_0_g53696 ) / ( _NoiseMaxValue - temp_output_7_0_g53696 ) ) );
				float4 lerpResult4044_g53655 = lerp( _NoiseColorTwo , _NoiseColorOne , Noise_Mask4030_g53655);
				half3 Noise_Tint4031_g53655 = (lerpResult4044_g53655).rgb;
				...
				float3 ObjectPosition4422_g53655 = temp_output_114_0_g53682;
				float2 panner73_g53679 = ( _TimeParameters.x * (TVE_NoiseParams).xy + ( (ObjectPosition4422_g53655).xz * TVE_NoiseParams.z ));
				float4 tex2DNode75_g53679 = tex2D( TVE_NoiseTex, panner73_g53679 );
				float3 Position83_g53692 = ObjectPosition4422_g53655;
				float temp_output_84_0_g53692 = _LayerMotionValue;
				float4 lerpResult87_g53692 = lerp( TVE_MotionParams , SAMPLE_TEXTURE2D_ARRAY( TVE_MotionTex, samplerTVE_MotionTex, ( (TVE_MotionCoord).zw + ( (TVE_MotionCoord).xy * (Position83_g53692).xz ) ),temp_output_84_0_g53692 ) , TVE_MotionUsage[(int)temp_output_84_0_g53692]);
				half4 Global_Motion_Params4344_g53655 = lerpResult87_g53692;
				float4 break322_g53685 = Global_Motion_Params4344_g53655;
				half Wind_Power369_g53685 = break322_g53685.z;
				half Wind_Power2223_g53655 = Wind_Power369_g53685;
				float temp_output_167_0_g53679 = Wind_Power2223_g53655;
				float lerpResult169_g53679 = lerp( 4.0 , 2.0 , temp_output_167_0_g53679);
				half Global_NoiseTex_H2869_g53655 = pow( abs( tex2DNode75_g53679.a ) , lerpResult169_g53679 );
				float lerpResult376_g53685 = lerp( TVE_MotionParamsMin.x , TVE_MotionParamsMax.x , Wind_Power369_g53685);
				half Wind_Power_103106_g53655 = lerpResult376_g53685;
				float3 worldToObj3565_g53655 = mul( GetWorldToObjectMatrix(), float4( temp_output_3563_0_g53655, 1 ) ).xyz;
				float3 VertexPosition3564_g53655 = worldToObj3565_g53655;
				float temp_output_3572_0_g53655 = saturate( VertexPosition3564_g53655.y );
				half Mesh_Height1524_g53655 = temp_output_3572_0_g53655;
				half Main_Mask_Variation_Or_Metallic3607_g53655 = break3589_g53655.r;
				half3 Highlight_Tint3904_g53655 = ( ( (_MotionHighlightColor).rgb * Global_NoiseTex_H2869_g53655 * Wind_Power_103106_g53655 * Mesh_Height1524_g53655 * Main_Mask_Variation_Or_Metallic3607_g53655 ) + float3( 1,1,1 ) );
				#ifdef TVE_IS_GRASS_SHADER
				float3 staticSwitch4284_g53655 = Highlight_Tint3904_g53655;
				#else
				float3 staticSwitch4284_g53655 = _Vector10;
				#endif
				half3 Blend_AlbedoTinted3958_g53655 = ( Blend_Albedo4137_g53655 * Noise_Tint4031_g53655 * staticSwitch4284_g53655 );
				float dotResult4002_g53655 = dot( Blend_AlbedoTinted3958_g53655 , float3(0.2126,0.7152,0.0722) );
				float3 temp_cast_7 = (dotResult4002_g53655).xxx;
				float3 Position58_g53672 = World_Pos4027_g53655;
				float temp_output_82_0_g53672 = _LayerColorsValue;
				float4 lerpResult88_g53672 = lerp( TVE_ColorsParams , SAMPLE_TEXTURE2D_ARRAY( TVE_ColorsTex, samplerTVE_ColorsTex, ( (TVE_ColorsCoord).zw + ( (TVE_ColorsCoord).xy * (Position58_g53672).xz ) ),temp_output_82_0_g53672 ) , TVE_ColorsUsage[(int)temp_output_82_0_g53672]);
				half Global_ColorsTex_A1701_g53655 = (lerpResult88_g53672).a;
				half Global_Colors_Influence3998_g53655 = Global_ColorsTex_A1701_g53655;
				float3 lerpResult4004_g53655 = lerp( Blend_AlbedoTinted3958_g53655 , temp_cast_7 , Global_Colors_Influence3998_g53655);
				half3 Global_ColorsTex_RGB1700_g53655 = (lerpResult88_g53672).rgb;
				#ifdef UNITY_COLORSPACE_GAMMA
				float staticSwitch1_g53699 = 2.0;
				#else
				float staticSwitch1_g53699 = 4.594794;
				#endif
				half3 Global_Colors3856_g53655 = ( Global_ColorsTex_RGB1700_g53655 * staticSwitch1_g53699 );
				float lerpResult4092_g53655 = lerp( 1.0 , Main_Mask_Variation_Or_Metallic3607_g53655 , _ColorsVariationValue);
				half Global_Colors_Value3999_g53655 = ( _GlobalColors * lerpResult4092_g53655 );
				half Main_Mask_Subsurface_Or_Blend3609_g53655 = break3589_g53655.b;
				#ifdef TVE_IS_GRASS_SHADER
				float staticSwitch4275_g53655 = ( 1.0 - Main_Mask_Subsurface_Or_Blend3609_g53655 );
				#else
				float staticSwitch4275_g53655 = Main_Mask_Subsurface_Or_Blend3609_g53655;
				#endif
				float temp_output_7_0_g53704 = _ColorsMaskMinValue;
				half Global_Colors_Mask4022_g53655 = ( saturate( ( ( staticSwitch4275_g53655 - temp_output_7_0_g53704 ) / ( _ColorsMaskMaxValue - temp_output_7_0_g53704 ) ) ) * Main_Mask_Leaves3712_g53655 );
				float3 lerpResult4007_g53655 = lerp( Blend_AlbedoTinted3958_g53655 , ( lerpResult4004_g53655 * Global_Colors3856_g53655 ) , ( Global_Colors_Value3999_g53655 * Global_Colors_Mask4022_g53655 ));
				float3 lerpResult4086_g53655 = lerp( Blend_Albedo4137_g53655 , lerpResult4007_g53655 , Main_Mask_Leaves3712_g53655);
				half3 Blend_AlbedoColored3711_g53655 = lerpResult4086_g53655;
				float3 temp_output_3681_0_g53655 = (_SubsurfaceColor).rgb;
				float dotResult4019_g53655 = dot( temp_output_3681_0_g53655 , float3(0.2126,0.7152,0.0722) );
				float3 temp_cast_10 = (dotResult4019_g53655).xxx;
				float3 lerpResult4018_g53655 = lerp( temp_output_3681_0_g53655 , temp_cast_10 , Global_Colors_Influence3998_g53655);
				float3 lerpResult4017_g53655 = lerp( temp_output_3681_0_g53655 , ( lerpResult4018_g53655 * Global_Colors3856_g53655 ) , ( Global_Colors_Value3999_g53655 * Global_Colors_Mask4022_g53655 ));
				half3 Subsurface_Color3656_g53655 = lerpResult4017_g53655;
				half MainLight_Subsurface4111_g53655 = TVE_MainLightParams.a;
				half Subsurface_Intensity3684_g53655 = ( _SubsurfaceValue * MainLight_Subsurface4111_g53655 );
				float temp_output_7_0_g53668 = _SubsurfaceMaskMinValue;
				half Subsurface_Mask3666_g53655 = ( saturate( ( ( Main_Mask_Subsurface_Or_Blend3609_g53655 - temp_output_7_0_g53668 ) / ( _SubsurfaceMaskMaxValue - temp_output_7_0_g53668 ) ) ) * Main_Mask_Leaves3712_g53655 );
				half3 Subsurface_Transmission3659_g53655 = ( Subsurface_Color3656_g53655 * Subsurface_Intensity3684_g53655 * Subsurface_Mask3666_g53655 );
				half3 MainLight_Direction4110_g53655 = TVE_MainLightDirection;
				float3 ase_worldViewDir = ( _WorldSpaceCameraPos.xyz - ase_worldPos );
				ase_worldViewDir = normalize(ase_worldViewDir);
				float3 normalizeResult3635_g53655 = normalize( ase_worldViewDir );
				float dotResult3631_g53655 = dot( -MainLight_Direction4110_g53655 , normalizeResult3635_g53655 );
				float saferPower3620_g53655 = max( (dotResult3631_g53655*0.5 + 0.5) , 0.0001 );
				#ifdef UNITY_PASS_FORWARDADD
				float staticSwitch3636_g53655 = 0.0;
				#else
				float staticSwitch3636_g53655 = ( pow( saferPower3620_g53655 , _MainLightAngleValue ) * _MainLightScatteringValue );
				#endif
				half Mask_Subsurface_View3614_g53655 = staticSwitch3636_g53655;
				half3 World_Normal3638_g53655 = o.Normal;
				float dotResult3625_g53655 = dot( MainLight_Direction4110_g53655 , World_Normal3638_g53655 );
				float lerpResult4385_g53655 = lerp( 1.0 , saturate( dotResult3625_g53655 ) , _MainLightNormalValue);
				#ifdef TVE_IS_GRASS_SHADER
				float staticSwitch4387_g53655 = 1.0;
				#else
				float staticSwitch4387_g53655 = lerpResult4385_g53655;
				#endif
				#ifdef UNITY_PASS_FORWARDADD
				float staticSwitch3618_g53655 = 0.0;
				#else
				float staticSwitch3618_g53655 = staticSwitch4387_g53655;
				#endif
				half Mask_Subsurface_Normal3637_g53655 = staticSwitch3618_g53655;
				half3 Subsurface_Scattering3702_g53655 = ( Subsurface_Transmission3659_g53655 * Blend_AlbedoColored3711_g53655 * Mask_Subsurface_View3614_g53655 * Mask_Subsurface_Normal3637_g53655 );
				half3 Albedo_Subsurface3874_g53655 = ( Blend_AlbedoColored3711_g53655 + Subsurface_Scattering3702_g53655 );
				half3 Global_OverlayColor1758_g53655 = (TVE_OverlayColor).rgb;
				half Main_AlbedoTex_G3807_g53655 = Main_Albedo_Raw4295_g53655.y;
				float3 Position82_g53669 = World_Pos4027_g53655;
				float temp_output_84_0_g53669 = _LayerExtrasValue;
				float4 lerpResult88_g53669 = lerp( TVE_ExtrasParams , SAMPLE_TEXTURE2D_ARRAY( TVE_ExtrasTex, samplerTVE_ExtrasTex, ( (TVE_ExtrasCoord).zw + ( (TVE_ExtrasCoord).xy * (Position82_g53669).xz ) ),temp_output_84_0_g53669 ) , TVE_ExtrasUsage[(int)temp_output_84_0_g53669]);
				float4 break89_g53669 = lerpResult88_g53669;
				half Global_ExtrasTex_Overlay156_g53655 = break89_g53669.b;
				float temp_output_3774_0_g53655 = ( _GlobalOverlay * Global_ExtrasTex_Overlay156_g53655 );
				float lerpResult3746_g53655 = lerp( 1.0 , Main_Mask_Variation_Or_Metallic3607_g53655 , _OverlayVariationValue);
				half Overlay_Commons3739_g53655 = ( temp_output_3774_0_g53655 * lerpResult3746_g53655 );
				#ifdef TVE_IS_GRASS_SHADER
				float staticSwitch4267_g53655 = ( ( ( Main_Mask_Subsurface_Or_Blend3609_g53655 * 0.5 ) + Main_AlbedoTex_G3807_g53655 ) * Overlay_Commons3739_g53655 );
				#else
				float staticSwitch4267_g53655 = ( ( ( World_Normal3638_g53655.y * 0.5 ) + Main_AlbedoTex_G3807_g53655 ) * Overlay_Commons3739_g53655 );
				#endif
				float temp_output_7_0_g53701 = _OverlayMaskMinValue;
				half Overlay_Mask3762_g53655 = saturate( ( ( staticSwitch4267_g53655 - temp_output_7_0_g53701 ) / ( _OverlayMaskMaxValue - temp_output_7_0_g53701 ) ) );
				float3 lerpResult3875_g53655 = lerp( Albedo_Subsurface3874_g53655 , Global_OverlayColor1758_g53655 , Overlay_Mask3762_g53655);
				half3 Final_Albedo4100_g53655 = lerpResult3875_g53655;
				half IsInitialized3811_g53655 = _IsInitialized;
				float3 lerpResult3815_g53655 = lerp( float3( 1,0,0 ) , Final_Albedo4100_g53655 , IsInitialized3811_g53655);
				float3 localLODFadeCustom3987_g53655 = ( lerpResult3815_g53655 );
				{
				...
				#ifdef LOD_FADE_CROSSFADE
				float3 staticSwitch3989_g53655 = localLODFadeCustom3987_g53655;
				#else
				float3 staticSwitch3989_g53655 = lerpResult3815_g53655;
				#endif
				
				float4 temp_output_4421_0_g53655 = ( _EmissiveColor * _EmissiveIntensityParams.x );
				half Global_ExtrasTex_Emissive4408_g53655 = break89_g53669.r;
				float lerpResult4417_g53655 = lerp( 1.0 , Global_ExtrasTex_Emissive4408_g53655 , _GlobalEmissive);
				half3 Final_Emissive4365_g53655 = ( (( temp_output_4421_0_g53655 * output1 )).rgb * lerpResult4417_g53655 );
				
				float3 temp_cast_14 = (( 0.04 * _RenderSpecular )).xxx;
				
				half Main_Mask_Smoothness3820_g53655 = break3589_g53655.a;
				half Main_Smoothness3838_g53655 = ( Main_Mask_Smoothness3820_g53655 * _ImpostorSmoothnessValue );
				half Global_ExtrasTex_Wetness305_g53655 = break89_g53669.g;
				float lerpResult3892_g53655 = lerp( Main_Smoothness3838_g53655 , saturate( ( Main_Smoothness3838_g53655 + Global_ExtrasTex_Wetness305_g53655 ) ) , _GlobalWetness);
				half Final_Smoothness3898_g53655 = lerpResult3892_g53655;
				
				float temp_output_3577_0_g53655 = o.Alpha;
				float localCustomAlphaClipAlways4430_g53655 = ( temp_output_3577_0_g53655 );
				float lerpResult4049_g53655 = lerp( 0.9 , (Main_Mask_Variation_Or_Metallic3607_g53655*0.5 + 0.5) , _AlphaVariationValue);
				half Global_ExtrasTex_Alpha1033_g53655 = break89_g53669.a;
				float lerpResult4053_g53655 = lerp( 1.0 , ( ( lerpResult4049_g53655 - ( 1.0 - Global_ExtrasTex_Alpha1033_g53655 ) ) + 0.1 ) , _GlobalAlpha);
				float lerpResult4075_g53655 = lerp( 1.0 , saturate( lerpResult4053_g53655 ) , Main_Mask_Leaves3712_g53655);
				half Final_Alpha4102_g53655 = lerpResult4075_g53655;
				float Alpha4430_g53655 = Final_Alpha4102_g53655;
				{
				clip(Alpha4430_g53655 - 0.1);
				}
				
				
		        float3 Albedo = staticSwitch3989_g53655;
				float3 Normal = World_Normal3638_g53655;
				float3 Emission = Final_Emissive4365_g53655;
				float3 Specular = temp_cast_14;
				float Metallic = 0;
				float Smoothness = Final_Smoothness3898_g53655;
				float Occlusion = 1;
				float3 Transmission = 1;
				float3 Translucency = 1;
				float Alpha = localCustomAlphaClipAlways4430_g53655;
        ...
        Pass
        {
           ...
           #pragma multi_compile GPU_FRUSTUM_ON __
            ...
            VertexOutput vert(GraphVertexInput v)
            {
				...
				float3 vertexValue = Final_VertexPosition890_g53655;
...
/*ASEBEGIN
Version=18910
1920;0;1920;1029;2220.088;418.5995;1;True;False
...
Node;AmplifyShaderEditor.FunctionNode;397;-1408,512;Inherit;False;Define Pipeline Universal AI;-1;;53706;ba69d246da7a8ba47a16a174259c237e;0;0;1;FLOAT;529
Node;AmplifyShaderEditor.RangedFloatNode;386;-1152,-768;Half;False;Property;_subsurface_shadow;_subsurface_shadow;143;1;[HideInInspector];Create;True;0;0;0;True;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;387;-1408,-768;Half;False;Property;_IsVegetationShader;_IsVegetationShader;144;1;[HideInInspector];Create;True;0;0;0;True;0;False;1;1;1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;367;-1664,512;Inherit;False;Is ShaderType;-1;;53705;90bdd02d483309144a404aee7f41383d;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;395;-768,-768;Inherit;False;Compile Impostors;-1;;53654;1cfd52e266bd86c47a094d0358cb5b93;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;394;-576,-768;Inherit;False;Compile All Shaders;-1;;53653;e67c8238031dbf04ab79a5d4d63d1b4f;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;385;-1024,-256;Inherit;False;Base Impostor;20;;53655;47a437226c28ea34bad309b04e5582cd;32,4299,0,4399,1,4398,1,4400,1,4406,1,4405,1,4404,1,4412,1,4410,1,4447,1,4010,1,4020,1,3868,1,4338,1,4336,1,3881,1,3891,1,4416,1,4434,1,1745,1,3479,0,3707,1,3697,1,3946,1,3952,0,3947,1,4186,0,1742,0,3484,0,860,1,2260,1,2261,1;7;3592;COLOR;0,0,0,0;False;4370;COLOR;0,0,0,0;False;3583;FLOAT3;0,0,0;False;3574;FLOAT3;0,0,0;False;3577;FLOAT;0;False;3563;FLOAT3;0,0,0;False;3964;FLOAT3;0,0,0;False;15;FLOAT3;3597;FLOAT3;3594;FLOAT3;4372;FLOAT;4373;FLOAT;3595;FLOAT;4119;FLOAT;3598;FLOAT;3980;FLOAT3;3974;FLOAT;3973;FLOAT;3975;FLOAT;4334;FLOAT;3593;FLOAT;4335;FLOAT3;534
...
ASEEND*/
//CHKSM=4D5CFCD52D038B1ADCD2A281B748A7529AA9D938
