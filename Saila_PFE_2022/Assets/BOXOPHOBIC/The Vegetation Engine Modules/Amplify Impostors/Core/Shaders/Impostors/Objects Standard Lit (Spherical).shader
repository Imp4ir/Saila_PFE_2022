    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            GraphVertexOutput vert (GraphVertexInput v)
        	{
				...
				float3 Final_VertexPosition890_g53756 = ( float3(0,0,0) + _DisableSRPBatcher );
				
				SphereImpostorVertex( v.vertex, v.normal, o.frameUVs99, o.viewPos99 );
				
				v.vertex.xyz += Final_VertexPosition890_g53756;
        	...
        	half4 frag (GraphVertexOutput IN, out float outDepth : SV_Depth ) : SV_Target
            {
				...
				half3 Main_Albedo_Raw4295_g53756 = o.Albedo;
				float dotResult4326_g53756 = dot( float3(0.2126,0.7152,0.0722) , Main_Albedo_Raw4295_g53756 );
				float3 temp_cast_0 = (dotResult4326_g53756).xxx;
				float3 lerpResult4294_g53756 = lerp( temp_cast_0 , Main_Albedo_Raw4295_g53756 , _ImpostorPropSaturationValue);
				half3 Main_Albedo3817_g53756 = ( lerpResult4294_g53756 * (_ImpostorPropColor).rgb );
				float3 temp_output_3563_0_g53756 = worldPos;
				float3 World_Pos4027_g53756 = temp_output_3563_0_g53756;
				half2 Second_UVs4286_g53756 = ( ( (World_Pos4027_g53756).xz * (_SecondUVs).xy ) + (_SecondUVs).zw );
				half3 Second_Albedo4241_g53756 = (( tex2D( _SecondAlbedoTex, Second_UVs4286_g53756 ) * _SecondColor )).rgb;
				#ifdef UNITY_COLORSPACE_GAMMA
				float staticSwitch1_g53785 = 2.0;
				#else
				float staticSwitch1_g53785 = 4.594794;
				#endif
				half3 World_Normal3638_g53756 = o.Normal;
				float lerpResult4185_g53756 = lerp( World_Normal3638_g53756.y , -World_Normal3638_g53756.y , _DetailProjectionMode);
				half Blend_Source4135_g53756 = ( lerpResult4185_g53756 + _DetailMeshValue );
				float4 break3589_g53756 = output0;
				half Main_Mask_Subsurface_Or_Blend3609_g53756 = break3589_g53756.b;
				float temp_output_7_0_g53787 = _DetailBlendMinValue;
				half Mask_Detail4138_g53756 = saturate( ( ( saturate( ( Blend_Source4135_g53756 + ( Blend_Source4135_g53756 * Main_Mask_Subsurface_Or_Blend3609_g53756 ) ) ) - temp_output_7_0_g53787 ) / ( _DetailBlendMaxValue - temp_output_7_0_g53787 ) ) );
				float3 lerpResult4207_g53756 = lerp( Main_Albedo3817_g53756 , ( Main_Albedo3817_g53756 * Second_Albedo4241_g53756 * staticSwitch1_g53785 ) , Mask_Detail4138_g53756);
				float3 lerpResult4214_g53756 = lerp( Main_Albedo3817_g53756 , Second_Albedo4241_g53756 , Mask_Detail4138_g53756);
				#if defined(TVE_DETAIL_BLEND_OVERLAY)
				float3 staticSwitch4153_g53756 = lerpResult4207_g53756;
				#elif defined(TVE_DETAIL_BLEND_REPLACE)
				float3 staticSwitch4153_g53756 = lerpResult4214_g53756;
				#else
				float3 staticSwitch4153_g53756 = lerpResult4207_g53756;
				#endif
				#if defined(TVE_DETAIL_MODE_OFF)
				float3 staticSwitch4189_g53756 = Main_Albedo3817_g53756;
				#elif defined(TVE_DETAIL_MODE_ON)
				float3 staticSwitch4189_g53756 = staticSwitch4153_g53756;
				#else
				float3 staticSwitch4189_g53756 = Main_Albedo3817_g53756;
				#endif
				half3 Blend_Albedo4137_g53756 = staticSwitch4189_g53756;
				float3 _Vector10 = float3(1,1,1);
				half3 Blend_AlbedoTinted3958_g53756 = ( Blend_Albedo4137_g53756 * float3(1,1,1) * _Vector10 );
				half Main_Mask_Leaves3712_g53756 = ceil( break3589_g53756.g );
				float3 lerpResult4086_g53756 = lerp( Blend_Albedo4137_g53756 , Blend_AlbedoTinted3958_g53756 , Main_Mask_Leaves3712_g53756);
				half3 Blend_AlbedoColored3711_g53756 = lerpResult4086_g53756;
				half3 Albedo_Subsurface3874_g53756 = Blend_AlbedoColored3711_g53756;
				half3 Global_OverlayColor1758_g53756 = (TVE_OverlayColor).rgb;
				half Main_AlbedoTex_G3807_g53756 = Main_Albedo_Raw4295_g53756.y;
				float3 Position82_g53760 = World_Pos4027_g53756;
				float temp_output_84_0_g53760 = _LayerExtrasValue;
				float4 lerpResult88_g53760 = lerp( TVE_ExtrasParams , SAMPLE_TEXTURE2D_ARRAY( TVE_ExtrasTex, samplerTVE_ExtrasTex, ( (TVE_ExtrasCoord).zw + ( (TVE_ExtrasCoord).xy * (Position82_g53760).xz ) ),temp_output_84_0_g53760 ) , TVE_ExtrasUsage[(int)temp_output_84_0_g53760]);
				float4 break89_g53760 = lerpResult88_g53760;
				half Global_ExtrasTex_Overlay156_g53756 = break89_g53760.b;
				float temp_output_3774_0_g53756 = ( _GlobalOverlay * Global_ExtrasTex_Overlay156_g53756 );
				half Overlay_Commons3739_g53756 = temp_output_3774_0_g53756;
				#ifdef TVE_IS_GRASS_SHADER
				float staticSwitch4267_g53756 = ( ( ( Main_Mask_Subsurface_Or_Blend3609_g53756 * 0.5 ) + Main_AlbedoTex_G3807_g53756 ) * Overlay_Commons3739_g53756 );
				#else
				float staticSwitch4267_g53756 = ( ( ( World_Normal3638_g53756.y * 0.5 ) + Main_AlbedoTex_G3807_g53756 ) * Overlay_Commons3739_g53756 );
				#endif
				float temp_output_7_0_g53786 = _OverlayMaskMinValue;
				half Overlay_Mask3762_g53756 = saturate( ( ( staticSwitch4267_g53756 - temp_output_7_0_g53786 ) / ( _OverlayMaskMaxValue - temp_output_7_0_g53786 ) ) );
				float3 lerpResult3875_g53756 = lerp( Albedo_Subsurface3874_g53756 , Global_OverlayColor1758_g53756 , Overlay_Mask3762_g53756);
				half3 Final_Albedo4100_g53756 = lerpResult3875_g53756;
				half IsInitialized3811_g53756 = _IsInitialized;
				float3 lerpResult3815_g53756 = lerp( float3( 1,0,0 ) , Final_Albedo4100_g53756 , IsInitialized3811_g53756);
				float3 localLODFadeCustom3987_g53756 = ( lerpResult3815_g53756 );
				{
				...
				#ifdef LOD_FADE_CROSSFADE
				float3 staticSwitch3989_g53756 = localLODFadeCustom3987_g53756;
				#else
				float3 staticSwitch3989_g53756 = lerpResult3815_g53756;
				#endif
				
				float4 temp_output_4421_0_g53756 = ( _EmissiveColor * _EmissiveIntensityParams.x );
				half Global_ExtrasTex_Emissive4408_g53756 = break89_g53760.r;
				float lerpResult4417_g53756 = lerp( 1.0 , Global_ExtrasTex_Emissive4408_g53756 , _GlobalEmissive);
				half3 Final_Emissive4365_g53756 = ( (( temp_output_4421_0_g53756 * output1 )).rgb * lerpResult4417_g53756 );
				
				half Main_Mask_Variation_Or_Metallic3607_g53756 = break3589_g53756.r;
				half Final_Metallic3834_g53756 = ( Main_Mask_Variation_Or_Metallic3607_g53756 * _ImpostorMetallicValue );
				
				half Main_Mask_Smoothness3820_g53756 = break3589_g53756.a;
				half Main_Smoothness3838_g53756 = ( Main_Mask_Smoothness3820_g53756 * _ImpostorSmoothnessValue );
				half Global_ExtrasTex_Wetness305_g53756 = break89_g53760.g;
				float lerpResult3892_g53756 = lerp( Main_Smoothness3838_g53756 , saturate( ( Main_Smoothness3838_g53756 + Global_ExtrasTex_Wetness305_g53756 ) ) , _GlobalWetness);
				half Final_Smoothness3898_g53756 = lerpResult3892_g53756;
				
				float temp_output_3577_0_g53756 = o.Alpha;
				
				
		        float3 Albedo = staticSwitch3989_g53756;
				float3 Normal = World_Normal3638_g53756;
				float3 Emission = Final_Emissive4365_g53756;
				float3 Specular = float3(0.5, 0.5, 0.5);
				float Metallic = Final_Metallic3834_g53756;
				float Smoothness = Final_Smoothness3898_g53756;
				float Occlusion = 1;
				float3 Transmission = 1;
				float3 Translucency = 1;
				float Alpha = temp_output_3577_0_g53756;
        ...
        Pass
        {
            ...
            VertexOutput vert(GraphVertexInput v)
            {
				...
				float3 vertexValue = Final_VertexPosition890_g53756;
...
/*ASEBEGIN
Version=18910
1920;0;1920;1029;2091.271;435.6801;1;True;False
...
Node;AmplifyShaderEditor.FunctionNode;298;-1024,-256;Inherit;False;Base Impostor;20;;53756;47a437226c28ea34bad309b04e5582cd;32,4299,1,4399,1,4398,1,4400,1,4406,1,4405,1,4404,1,4412,1,4410,1,4447,0,4010,0,4020,0,3868,0,4338,1,4336,1,3881,0,3891,1,4416,1,4434,0,1745,0,3479,0,3707,0,3697,0,3946,0,3952,0,3947,0,4186,1,1742,0,3484,0,860,0,2260,1,2261,1;7;3592;COLOR;0,0,0,0;False;4370;COLOR;0,0,0,0;False;3583;FLOAT3;0,0,0;False;3574;FLOAT3;0,0,0;False;3577;FLOAT;0;False;3563;FLOAT3;0,0,0;False;3964;FLOAT3;0,0,0;False;15;FLOAT3;3597;FLOAT3;3594;FLOAT3;4372;FLOAT;4373;FLOAT;3595;FLOAT;4119;FLOAT;3598;FLOAT;3980;FLOAT3;3974;FLOAT;3973;FLOAT;3975;FLOAT;4334;FLOAT;3593;FLOAT;4335;FLOAT3;534
Node;AmplifyShaderEditor.RangedFloatNode;108;-1408,-768;Half;False;Property;_IsObjectsShader;_IsObjectsShader;143;1;[HideInInspector];Create;True;0;0;0;True;0;False;1;1;1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;321;-768,-768;Inherit;False;Compile Impostors;-1;;53754;1cfd52e266bd86c47a094d0358cb5b93;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;323;-1408,512;Inherit;False;Define Pipeline Universal AI;-1;;53755;ba69d246da7a8ba47a16a174259c237e;0;0;1;FLOAT;529
Node;AmplifyShaderEditor.FunctionNode;320;-576,-768;Inherit;False;Compile All Shaders;-1;;53752;e67c8238031dbf04ab79a5d4d63d1b4f;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;306;-1664,512;Inherit;False;Define Shader Object;-1;;53753;1237b3cc9fbfe714d8343c91216dc9b4;0;0;1;FLOAT;0
...
WireConnection;315;8;298;534
ASEEND*/
//CHKSM=2D246DA0819E87BD16FFE8C52B6A4EEC90D9C94E
