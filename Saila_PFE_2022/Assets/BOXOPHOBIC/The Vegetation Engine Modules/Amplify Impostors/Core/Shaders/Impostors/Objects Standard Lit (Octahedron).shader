    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            GraphVertexOutput vert (GraphVertexInput v)
        	{
				...
				float3 Final_VertexPosition890_g53712 = ( float3(0,0,0) + _DisableSRPBatcher );
        	...
        	half4 frag (GraphVertexOutput IN, out float outDepth : SV_Depth ) : SV_Target
            {
				...
				float dotResult4326_g53712 = dot( float3(0.2126,0.7152,0.0722) , Main_Albedo_Raw4295_g53712 );
				float3 temp_cast_0 = (dotResult4326_g53712).xxx;
				float3 lerpResult4294_g53712 = lerp( temp_cast_0 , Main_Albedo_Raw4295_g53712 , _ImpostorPropSaturationValue);
				half3 Main_Albedo3817_g53712 = ( lerpResult4294_g53712 * (_ImpostorPropColor).rgb );
				float3 temp_output_3563_0_g53712 = worldPos;
				float3 World_Pos4027_g53712 = temp_output_3563_0_g53712;
				half2 Second_UVs4286_g53712 = ( ( (World_Pos4027_g53712).xz * (_SecondUVs).xy ) + (_SecondUVs).zw );
				half3 Second_Albedo4241_g53712 = (( tex2D( _SecondAlbedoTex, Second_UVs4286_g53712 ) * _SecondColor )).rgb;
				#ifdef UNITY_COLORSPACE_GAMMA
				float staticSwitch1_g53741 = 2.0;
				#else
				float staticSwitch1_g53741 = 4.594794;
				#endif
				half3 World_Normal3638_g53712 = o.Normal;
				float lerpResult4185_g53712 = lerp( World_Normal3638_g53712.y , -World_Normal3638_g53712.y , _DetailProjectionMode);
				half Blend_Source4135_g53712 = ( lerpResult4185_g53712 + _DetailMeshValue );
				float4 break3589_g53712 = output0;
				half Main_Mask_Subsurface_Or_Blend3609_g53712 = break3589_g53712.b;
				float temp_output_7_0_g53743 = _DetailBlendMinValue;
				half Mask_Detail4138_g53712 = saturate( ( ( saturate( ( Blend_Source4135_g53712 + ( Blend_Source4135_g53712 * Main_Mask_Subsurface_Or_Blend3609_g53712 ) ) ) - temp_output_7_0_g53743 ) / ( _DetailBlendMaxValue - temp_output_7_0_g53743 ) ) );
				float3 lerpResult4207_g53712 = lerp( Main_Albedo3817_g53712 , ( Main_Albedo3817_g53712 * Second_Albedo4241_g53712 * staticSwitch1_g53741 ) , Mask_Detail4138_g53712);
				float3 lerpResult4214_g53712 = lerp( Main_Albedo3817_g53712 , Second_Albedo4241_g53712 , Mask_Detail4138_g53712);
				#if defined(TVE_DETAIL_BLEND_OVERLAY)
				float3 staticSwitch4153_g53712 = lerpResult4207_g53712;
				#elif defined(TVE_DETAIL_BLEND_REPLACE)
				float3 staticSwitch4153_g53712 = lerpResult4214_g53712;
				#else
				float3 staticSwitch4153_g53712 = lerpResult4207_g53712;
				#endif
				#if defined(TVE_DETAIL_MODE_OFF)
				float3 staticSwitch4189_g53712 = Main_Albedo3817_g53712;
				#elif defined(TVE_DETAIL_MODE_ON)
				float3 staticSwitch4189_g53712 = staticSwitch4153_g53712;
				#else
				float3 staticSwitch4189_g53712 = Main_Albedo3817_g53712;
				#endif
				half3 Blend_Albedo4137_g53712 = staticSwitch4189_g53712;
				float3 _Vector10 = float3(1,1,1);
				half3 Blend_AlbedoTinted3958_g53712 = ( Blend_Albedo4137_g53712 * float3(1,1,1) * _Vector10 );
				half Main_Mask_Leaves3712_g53712 = ceil( break3589_g53712.g );
				float3 lerpResult4086_g53712 = lerp( Blend_Albedo4137_g53712 , Blend_AlbedoTinted3958_g53712 , Main_Mask_Leaves3712_g53712);
				half3 Blend_AlbedoColored3711_g53712 = lerpResult4086_g53712;
				half3 Albedo_Subsurface3874_g53712 = Blend_AlbedoColored3711_g53712;
				...
				half Overlay_Commons3739_g53712 = temp_output_3774_0_g53712;
				...
				half Final_Metallic3834_g53712 = ( Main_Mask_Variation_Or_Metallic3607_g53712 * _ImpostorMetallicValue );
				...
				float Metallic = Final_Metallic3834_g53712;
				float Smoothness = Final_Smoothness3898_g53712;
				float Occlusion = 1;
				float3 Transmission = 1;
				float3 Translucency = 1;
				float Alpha = temp_output_3577_0_g53712;
...
/*ASEBEGIN
Version=18910
1920;0;1920;1029;2019.754;551.08;1;True;False
...
Node;AmplifyShaderEditor.FunctionNode;341;-1025,-257;Inherit;False;Base Impostor;20;;53712;47a437226c28ea34bad309b04e5582cd;32,4299,1,4399,1,4398,1,4400,1,4406,1,4405,1,4404,1,4412,1,4410,1,4447,0,4010,0,4020,0,3868,0,4338,1,4336,1,3881,0,3891,1,4416,1,4434,0,1745,0,3479,0,3707,0,3697,0,3946,0,3952,0,3947,0,4186,1,1742,0,3484,0,860,0,2260,1,2261,1;7;3592;COLOR;0,0,0,0;False;4370;COLOR;0,0,0,0;False;3583;FLOAT3;0,0,0;False;3574;FLOAT3;0,0,0;False;3577;FLOAT;0;False;3563;FLOAT3;0,0,0;False;3964;FLOAT3;0,0,0;False;15;FLOAT3;3597;FLOAT3;3594;FLOAT3;4372;FLOAT;4373;FLOAT;3595;FLOAT;4119;FLOAT;3598;FLOAT;3980;FLOAT3;3974;FLOAT;3973;FLOAT;3975;FLOAT;4334;FLOAT;3593;FLOAT;4335;FLOAT3;534
Node;AmplifyShaderEditor.FunctionNode;348;-576,-768;Inherit;False;Compile All Shaders;-1;;53710;e67c8238031dbf04ab79a5d4d63d1b4f;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;351;-1408,512;Inherit;False;Define Pipeline Universal AI;-1;;53711;ba69d246da7a8ba47a16a174259c237e;0;0;1;FLOAT;529
...
Node;AmplifyShaderEditor.FunctionNode;349;-768,-768;Inherit;False;Compile Impostors;-1;;53708;1cfd52e266bd86c47a094d0358cb5b93;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;312;-1664,512;Inherit;False;Define Shader Object;-1;;53709;1237b3cc9fbfe714d8343c91216dc9b4;0;0;1;FLOAT;0
...
WireConnection;343;8;341;534
ASEEND*/
//CHKSM=05EFA0095D7AD57C691EF5FAD32630F0BC442564
